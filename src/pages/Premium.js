...
const Premium = () => {
  ...
  const getUserInDB = async (_user) => {
    ...
    const GET_USER_ENDPOINT = `${constantsData.USER_MANAGEMENT_ENDPOINT}/api/v1/users`;
  ...
  const updatePremiumPlan = async (boolean) => {
    ...
    const PREMIUM_USER_ENDPOINT = `${constantsData.USER_MANAGEMENT_ENDPOINT}/api/v1/users/${userData.id}/premium`;
