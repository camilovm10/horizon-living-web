...
const SignUp = () => {
  ...
  const registerUser = async () => {
    ...
    const REGISTER_USER_ENDPOINT = `${constantsData.AUTHENTICATION_ENDPOINT}/api/v1/auth/register`;
  ...
  const createUserInDB = async () => {
    ...
    const CREATE_USER_ENDPOINT = `${constantsData.USER_MANAGEMENT_ENDPOINT}/api/v1/users/create`;
