...
const Admin = () => {
  ...
  const getUsersInDB = async () => {
    ...
    const GET_USERS_ENDPOINT = `${constantsData.USER_MANAGEMENT_ENDPOINT}/api/v1/users`;
...
const User = ({userData}) => {
  ...
  const updateUserInDB = async () => {
    ...
    const UPDATE_USER_ENDPOINT = `${constantsData.USER_MANAGEMENT_ENDPOINT}/api/v1/users/${userData.id}`;
  ...
  const deleteUser = async () => {
    ...
    const DELETE_USER_ENDPOINT = `${constantsData.USER_MANAGEMENT_ENDPOINT}/api/v1/users/${userData.id}`;
